 ...
 * @author Bartek
 */
public class RoomScreenFx2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {   
        ...
        pause.setOnFinished(new EventHandler<ActionEvent>()
        {
            ...
            public void handle(ActionEvent event) {
                if(!roomInited) {
                    lblRoom.setText(screenController.getName(0,1));
                    roomInited = true;
                }
                setFire();
                setHumidity();
    ...
    @FXML void chartShowEvent(MouseEvent event) {
        try {
            ...
            chartController.setRoomColumn(1);
     ...
     public void setTemp()
    {
            Platform.runLater(new Runnable()
            {
                ...
                public void run() 
                {
                    lblTemp.setText(screenController.getTemp(0, 1));
                }
            });  
    }
    ...
    public void setHumidity()
    {
            Platform.runLater(new Runnable()
            {
                ...
                public void run() 
                {
                    lblHum.setText(screenController.getHum(0, 1));
                }
            });
    }
    ...
    public void setLight()
    {
            Platform.runLater(new Runnable()
            {
                ...
                public void run() 
                {
                    ...
                    ObservableList<String> style = screenController.getLight(0,1);
    ...
    public void setFire()
    {
            Platform.runLater(new Runnable()
            {
                ...
                public void run() 
                {
                    ...
                    ObservableList<String> style = screenController.getFire(0,1);
    ...
    public void setMotion()
    {
            Platform.runLater(new Runnable()
            {
                ...
                public void run() 
                {
                    ...
                    ObservableList<String> style = screenController.getMotion(0,1);
