 ...
 * @author Bartek
 */
public class RoomScreenFx4Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {   
        ...
        pause.setOnFinished(new EventHandler<ActionEvent>()
        {
            ...
            public void handle(ActionEvent event) {
                if(!roomInited) {
                    lblRoom.setText(screenController.getName(1,0));
                    roomInited = true;
                }
                setFire();
                setHumidity();
    ...
    @FXML void chartShowEvent(MouseEvent event) {
        try {
            ...
            chartController.setRoomRow(1);
            chartController.setRoomColumn(0);
     ...
     public void setTemp()
    {
            Platform.runLater(new Runnable()
            {
                ...
                public void run() 
                {
                    lblTemp.setText(screenController.getTemp(1, 0));
                }
            });  
    }
    ...
    public void setHumidity()
    {
            Platform.runLater(new Runnable()
            {
                ...
                public void run() 
                {
                    lblHum.setText(screenController.getHum(1, 0));
                }
            });
    }
    ...
    public void setLight()
    {
            Platform.runLater(new Runnable()
            {
                ...
                public void run() 
                {
                    ...
                    ObservableList<String> style = screenController.getLight(1,0);
    ...
    public void setFire()
    {
            Platform.runLater(new Runnable()
            {
                ...
                public void run() 
                {
                    ...
                    ObservableList<String> style = screenController.getFire(1,0);
    ...
    public void setMotion()
    {
            Platform.runLater(new Runnable()
            {
                ...
                public void run() 
                {
                    ...
                    ObservableList<String> style = screenController.getMotion(1,0);
